...
def save_paths(n_clicks, file_paths_text, path_set_name):
    ...
    try:
        ...
        if success:
            message = html.Div(
                f"Successfully saved {len(file_paths)} paths as '{path_set_name}'",
                style={
                    "color": "green"})
        else:
...
if __name__ == "__main__":
    ...
    print(
        f"Preferences file: {os.path.expanduser('~/.openfast_plotter/preferences.json')}")
